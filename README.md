...
## ユーザ管理：実装完了
#### 新規登録
- 「新規登録」ボタンをクリックし、新規登録ページにアクセスする<br>
...
- 新規登録ページにて、プロフィールを入力し、「会員登録」ボタンをクリックする<br>
https://gyazo.com/9149879c5077f7afe58670040eb16292

- トップページのユーザ一覧(Your Climbing Partners!)にて、作成したアカウントが表される<br>
https://gyazo.com/5d9899077887d3d44c0d6f5ef307878a

#### ログイン/ログオフ
- トップページ右上の「ログイン」ボタンをクリックし、ログインページにアクセスする<br>
https://gyazo.com/6a31ad6d02c4abbcc5e69c0d252d8698

- ログインページにて、メールアドレスとパスワードを入力し、「ログイン」ボタンをクリックする<br>
https://gyazo.com/2892954e81ed70fabee18582b883ecb1

- トップページ右上の「ログアウト」ボタンをクリックし、ログアウトする<br>
https://gyazo.com/879fbb136cc42e2b5f9b3c92cb31f539

### マッチング機能：実装完了
- トップページのユーザ一覧(Your Climbing Partners!)にて、気になるユーザをクリックし、プロフィールを確認する<br>
https://gyazo.com/81b6924abf01669c0b911bfdbd6b2583

- ユーザ詳細ページにてプロフィールを確認し、気に入ったら「フォローする」ボタンをクリックする<br>
