...
[^1]: belayer(ビレイヤー)とは、ロープクライミングにおけるパートナーの呼称のことです
...
#### ログイン/ログオフ
- トップページ右上の「ログイン」ボタンをクリックし、ログインページにアクセスする
https://gyazo.com/6a31ad6d02c4abbcc5e69c0d252d8698

- ログインページにて、メールアドレスとパスワードを入力し、「ログイン」ボタンをクリックする
https://gyazo.com/2892954e81ed70fabee18582b883ecb1

- トップページ右上の「ログアウト」ボタンをクリックし、ログアウトする
